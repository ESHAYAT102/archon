...
yay -S --noconfirm vicinae-bin tty-clock spicetify-cli crush-bin nautilus-backspace hyprmoncfg t3code-bin
...
bun i -g @google/gemini-cli @openai/codex @augmentcode/auggie port-whisperer
chsh -s /usr/bin/fish
...
ollama pull gemma3:latest && ollama pull rnj-1:latest && ollama pull ministral-3:latest && ollama pull qwen3-vl:latest
