...
bun i -g @google/gemini-cli @openai/codex @augmentcode/auggie port-whisperer git-open
chsh -s /usr/bin/fish
...
ollama pull gemma4:latest && ollama pull gemma4:e2b && ollama pull qwen3-vl:latest
