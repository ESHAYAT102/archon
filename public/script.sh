...
sudo pacman -S --noconfirm flatpak fish tmux ghostty 7zip yazi btop tree swaync nano ncmpcpp cava cmatrix stow lib32-mesa lib32-vulkan-intel vulkan-intel visual-studio-code-bin glow vhs shotwell zip unzip wget curl vlc hyprshot ttf-firacode-nerd ttf-cascadia-code
yay -S --noconfirm vicinae-bin tty-clock
